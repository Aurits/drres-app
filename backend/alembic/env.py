...
# Make sure models are importable from the backend root
...
from models import evidence, evidence_chunk  # noqa: F401 – registers models with Base
...
def run_migrations_offline() -> None:
    ...
    # Alembic requires a sync (psycopg2) driver — strip any async driver prefix
