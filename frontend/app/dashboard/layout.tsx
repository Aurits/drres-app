...
import { LayoutDashboard, FilePlus, FileText, Settings, ChevronLeft, TrendingUp } from "lucide-react";
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex w-full h-[calc(100vh-65px)] overflow-hidden relative z-10">
      ...
      {/* Sidebar */}
      <aside className="w-[260px] lg:w-[280px] bg-card hidden md:flex flex-col flex-shrink-0 h-full border-r border-border">
