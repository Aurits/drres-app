...
const MOCK_RECORDS: EvidenceRecord[] = [
  { id: "1", uniqueId: "DRRES-2025-001", title: "Facilitators of and Barriers to Uptake of Home-Based HIV Testing", submitter: "Dr. Amara Osei", submitterEmail: "a.osei@mak.ac.ug", type: "Primary Study", sdg: "SDG 3: Good Health", status: "Published", date: "2025-03-28", abstract: "Background: Integrating home-based HIV counseling and testing (HCT) with tuberculosis (TB) evaluation could improve the uptake of HIV testing among household contacts of patients with active TB.", authors: "Osei A., Kimani J., Nakamura T.", year: "2025", country: "Uganda", priorityArea: "Communicable Diseases", doi: "10.1097/QAI.0000000000001617", isFeatured: true },
  { id: "2", uniqueId: "DRRES-2025-002", title: "Climate-Resilient Agriculture Policies for Sub-Saharan Drylands", submitter: "Dr. Amara Osei", submitterEmail: "a.osei@mak.ac.ug", type: "Systematic Review", sdg: "SDG 13: Climate Action", status: "Published", date: "2025-03-15", abstract: "A comprehensive review of 144 pilot programs testing drought-resistant crop subsidies and soil moisture retention techniques across Sub-Saharan Africa.", authors: "Institute for Climate Impact", year: "2024", country: "Sub-Saharan Africa", priorityArea: "Food Security", doi: "10.1016/j.gfs.2024.100815" },
  { id: "3", uniqueId: "DRRES-2025-003", title: "AI in Primary Education: Infrastructure Requirements for Rural Deployment", submitter: "J. Kimani", submitterEmail: "j.kimani@uon.ac.ke", type: "Policy Brief", sdg: "SDG 4: Quality Education", status: "Published", date: "2025-02-22", abstract: "An analysis of the digital infrastructure gaps in rural East African schools and policy recommendations for bridging the EdTech divide.", authors: "African Tech Policy Network", year: "2024", country: "Kenya", priorityArea: "Digital Infrastructure", doi: "10.1080/02680513.2024.2312788" },
  { id: "4", uniqueId: "DRRES-2025-004", title: "Maternal Health Outcomes in Urban vs. Rural Settings Across East Africa", submitter: "Dr. Amara Osei", submitterEmail: "a.osei@mak.ac.ug", type: "Primary Study", sdg: "SDG 3: Good Health", status: "Published", date: "2025-02-10", abstract: "A multi-site study comparing maternal health outcomes across urban and rural settings in Uganda, Kenya, and Tanzania.", authors: "Osei A., Banda M., Wanjiku R.", year: "2025", country: "East Africa", priorityArea: "Accessible Healthcare", doi: "10.1016/j.healthpol.2025.03.001" },
  { id: "5", uniqueId: "DRRES-2025-005", title: "Water Sanitation Infrastructure and Cholera Prevention in Kampala Districts", submitter: "M. Banda", submitterEmail: "m.banda@makerere.ac.ug", type: "Rapid Response", sdg: "SDG 3: Good Health", status: "Published", date: "2025-01-18", abstract: "A rapid evidence synthesis examining the relationship between water sanitation infrastructure investments and cholera incidence.", authors: "Banda M., Odhiambo P.", year: "2025", country: "Uganda", priorityArea: "Global Health Security", doi: "10.1186/s12889-025-18234-w" },
  { id: "6", uniqueId: "DRRES-2025-006", title: "Renewable Solar Micro-Grid Deployment: Policy Frameworks for County-Level Implementation", submitter: "T. Nakamura", submitterEmail: "t.nakamura@jica.go.jp", type: "Policy Brief", sdg: "SDG 13: Climate Action", status: "Published", date: "2024-12-30", abstract: "Evaluating county-level policy frameworks for the deployment of solar micro-grids in off-grid communities across Kenya.", authors: "Nakamura T., Wambui S.", year: "2024", country: "Kenya", priorityArea: "Renewable Energy", doi: "10.1016/j.enpol.2024.114489" },
  { id: "7", uniqueId: "DRRES-2025-007", title: "Digital Literacy Training Outcomes Among Primary School Teachers in Western Kenya", submitter: "S. Wambui", submitterEmail: "s.wambui@ku.ac.ke", type: "Primary Study", sdg: "SDG 4: Quality Education", status: "Published", date: "2024-12-15", abstract: "Measuring the effectiveness of a 6-month digital literacy training program for primary school teachers.", authors: "Wambui S., Achieng L.", year: "2024", country: "Kenya", priorityArea: "Digital Infrastructure", doi: "" },
  { id: "8", uniqueId: "DRRES-2025-008", title: "Community Health Worker Retention Strategies: A Multi-Country Analysis", submitter: "Dr. Amara Osei", submitterEmail: "a.osei@mak.ac.ug", type: "Systematic Review", sdg: "SDG 3: Good Health", status: "Published", date: "2024-11-28", abstract: "Systematic analysis of retention strategies for community health workers across 8 Sub-Saharan African countries.", authors: "Osei A., Mwangi K., Diallo F.", year: "2024", country: "Sub-Saharan Africa", priorityArea: "Accessible Healthcare", doi: "10.1186/s12960-024-00923-w" },
  { id: "9", uniqueId: "DRRES-2025-009", title: "Impact of Drought-Resistant Crop Subsidies on Smallholder Farmer Incomes", submitter: "P. Odhiambo", submitterEmail: "p.odhiambo@cgiar.org", type: "Primary Study", sdg: "SDG 13: Climate Action", status: "Needs Review", date: "2025-04-05", abstract: "A randomized controlled trial examining the income effects of drought-resistant crop subsidies on smallholder farmers in the Sahel region.", authors: "Odhiambo P., Traoré A., Schmidt H.", year: "2025", country: "Sahel Region", priorityArea: "Food Security", doi: "10.1016/j.worlddev.2025.106389" },
  { id: "10", uniqueId: "DRRES-2025-010", title: "Antimicrobial Resistance Surveillance Networks: A Gap Analysis for Eastern Africa", submitter: "Dr. Amara Osei", submitterEmail: "a.osei@mak.ac.ug", type: "Primary Study", sdg: "SDG 3: Good Health", status: "Needs Review", date: "2025-04-02", abstract: "A comprehensive gap analysis of antimicrobial resistance surveillance networks across Eastern African nations, identifying critical infrastructure and capacity needs.", authors: "Osei A., Ngure K., Ssempijja V.", year: "2025", country: "Eastern Africa", priorityArea: "Communicable Diseases", doi: "10.1016/j.ijantimicag.2025.107123" },
  { id: "11", uniqueId: "DRRES-2025-011", title: "Soil Carbon Sequestration Potential Under Agroforestry Systems in the Sahel", submitter: "T. Nakamura", submitterEmail: "t.nakamura@jica.go.jp", type: "Policy Brief", sdg: "SDG 13: Climate Action", status: "Needs Review", date: "2025-04-06", abstract: "Policy brief evaluating the carbon sequestration potential of different agroforestry systems in Sahelian landscapes.", authors: "Nakamura T., Traoré A., Diallo F.", year: "2025", country: "Sahel Region", priorityArea: "Food Security", doi: "" },
  { id: "12", uniqueId: "DRRES-2025-012", title: "Mobile Health Interventions for Chronic Disease Management: Uganda Pilot Results", submitter: "M. Banda", submitterEmail: "m.banda@makerere.ac.ug", type: "Primary Study", sdg: "SDG 3: Good Health", status: "Draft", date: "2025-04-07", abstract: "Pilot study results from a mobile health intervention program for chronic disease management in urban Kampala.", authors: "Banda M., Osei A.", year: "2025", country: "Uganda", priorityArea: "Accessible Healthcare", doi: "" },
];
                ...
                return (
                  <tr key={record.id} className="border-b border-border/60 hover:bg-muted/10 transition-colors group relative">
                    <td className="px-5 py-4">
                      <span className="font-mono text-[11px] font-bold text-foreground tracking-[0.5px]">
                        {record.uniqueId}
                      </span>
                    </td>
                    <td className="px-4 py-4 min-w-[280px]">
                      <div className="flex flex-col gap-1">
                        <span className="font-serif text-[14px] font-bold text-foreground line-clamp-1 leading-tight">{record.title}</span>
                        <div className="flex items-center gap-2">
                          <span className="font-mono text-[9px] text-muted-foreground/60">{record.submitter}</span>
                          <span className="w-1 h-1 rounded-full bg-border" />
                          <span className="font-mono text-[9px] text-muted-foreground/60">{record.type}</span>
                        </div>
                      </div>
                    </td>
